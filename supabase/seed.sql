...
-- Initial users are now created via migration 0005_dev_users.sql
-- Available test users:
-- admin@example.com / password123 (admin role)
-- reviewer@example.com / password123 (reviewer role)  
-- annotator@example.com / password123 (annotator role)
...
-- Note: These will be added after users are created via script
...
-- Note: This will be added after users are created
